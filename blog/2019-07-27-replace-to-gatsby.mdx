...
一年ほど前にブログのシステムを[Hugoに切り替えた](./2018-04-24-replace-to-hugo.mdx)ばかりなのですが[Gatsby](https://www.gatsbyjs.org/)に変更しました。Hugoに切り替えた際に危惧していた通り、Hugoのテンプレートに慣れることがどうしてもできませんでした。
